...
BOT_TOKEN = environ.get('BOT_TOKEN', '5806016246:AAEocrUT_h8ZkM3dfqFWcNJsUk1_V_5uF9U')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Anusv1")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://tpfootball.live/mm")#http://mm.tpfootball.live")
